...
export const metadata = pageMetadata({
  ...
  description: "How Awwtomation collects, uses and protects personal data, including data from connected Instagram and Facebook accounts.",
  ...
  return (
    ...
    >
      ...
      <p>
        ...
        once (see our <Link href="/legal/data-deletion">data deletion page</Link>).
      </p>
