...
export const metadata = pageMetadata({
  ...
  description: "The terms that govern your use of Awwtomation, the Instagram and Facebook automation service.",
  ...
  return (
    ...
    >
      ...
      <p>
        ...
        <Link href="/legal/privacy-policy">Privacy Policy</Link>. If you use the Service on behalf of a company, you confirm you have
      ...
      <p>
        ...
        termination your data is deleted as described in the <Link href="/legal/data-deletion">data deletion page</Link>.
      </p>
