...
export default function BlogAutomationPage() {
  const serviceSeo = serviceDefinitions["blog-automation"]
      ...
      <section className="w-full min-h-[90vh] flex items-center py-20 px-4 md:px-12 relative overflow-hidden bg-gradient-to-br from-slate-50 via-purple-50 to-indigo-100 dark:from-slate-900 dark:via-slate-800 dark:to-slate-900">
        ...
        <div className="z-20 w-full max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="space-y-6">
            <PageBreadcrumbs items={getServiceBreadcrumbs(serviceSeo)} className="mb-4" />
  ...
  <div className="w-full">
    ...
    >
      ...
      <LinkCardSection
        ...
        description="These related pages reinforce the publishing, SEO, and internal-linking topics this service page should rank for."
        links={serviceSeo.relatedResources}
      />

      <FaqCardSection
        title="Frequently Asked Questions"
        description="Get answers to common questions about our blog automation services."
        faqs={serviceSeo.faqs}
      />

      <section className="py-20 px-4 md:px-12">
        <div className="max-w-5xl mx-auto text-center space-y-6">
          <h2 className="text-3xl md:text-4xl font-bold">Ready to Build a Blog Automation Workflow That Publishes Consistently?</h2>
          <p className="text-muted-foreground text-lg max-w-3xl mx-auto">
            We can help you connect keyword research, briefs, AI-assisted drafting, human review, publishing, and reporting
            into one repeatable content engine.
          </p>
          <Button
            size="lg"
          ...
          >
            Book Blog Automation Consultation <ChevronRight className="ml-1 h-4 w-4" />
          </Button>
        </div>
      </section>
{/* Footer */}
