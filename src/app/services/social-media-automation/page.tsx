      ...
      <div className="hidden sm:flex justify-center w-full">
        ...
        <section className="py-20 px-4 md:px-12 bg-muted/50">
          <div className="max-w-5xl mx-auto text-center space-y-4">
            <h2 className="text-3xl md:text-4xl font-bold">What is the Social Planner?</h2>
            <p className="text-muted-foreground md:text-xl">
              A centralized tool to help you schedule, publish, and analyze content across all major platforms. Simplify workflows, stay consistent, and boost engagement—without being online 24/7.
            </p>
          </div>
        </section>
        ...
        <section className="py-20 px-4 md:px-12">
          <div className="max-w-6xl mx-auto space-y-16">
            <h2 className="text-3xl md:text-4xl font-bold text-center">Platform-Specific Automation</h2>
              ...
              {[
                {
                  ...
                  name: "Facebook",
                  features: [
                    "Schedule posts to Pages and Groups",
                    "Automate replies to comments and messages",
                    "Sync lead ads with CRM",
                    "Post based on engagement analytics"
                  ]
                },
                {
                  icon: Instagram,
                  name: "Instagram",
                  features: [
                    "Schedule images, videos & carousels",
                    "Story reminders",
                    "Auto-publish with hashtags/location",
                    "DM monitoring and workflows"
                  ]
                },
                {
                  icon: Twitter,
                ...
                },
                {
                  ...
                  name: "LinkedIn",
                  features: [
                    "Schedule company/personal posts",
                    "Automate outreach workflows",
                    "Track engagement",
                    "Sync lead forms to CRM"
                  ]
                },
                {
                  icon: Globe,
                ...
                },
                {
                  ...
                  name: "YouTube",
                  features: [
                    "Schedule uploads & community posts",
                    "Auto-tagging, descriptions, playlists",
                    "CMS/video editor sync"
                  ]
                }
              ].map((platform, index) => (
                <div key={index} className="space-y-2 border p-4 rounded-lg bg-background shadow-sm">
                  <div className="flex items-center gap-2">
        ...
        <section className="py-20 px-4 md:px-12 bg-muted/50">
          <div className="max-w-5xl mx-auto text-center space-y-6">
            <h2 className="text-3xl font-bold">Workflow Integrations</h2>
            <p className="text-muted-foreground text-lg">
              Seamlessly connect with 300+ platforms including CRMs, email tools, content databases, AI systems, and team collaboration apps.
            </p>
            <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 gap-4 text-sm text-muted-foreground">
              {[
                "HubSpot", "Salesforce", "Zoho", "Mailchimp",
                "ConvertKit", "Google Sheets", "Airtable", "Notion",
                "Slack", "Discord", "Trello", "Klaviyo"
              ].map((tool, i) => (
                <span key={i} className="bg-background px-2 py-1 border rounded-md"><b>{tool}</b></span>
              ))}
            </div>
          </div>
        </section>
        ...
        <section className="py-20 px-4 md:px-12">
          <div className="max-w-4xl mx-auto space-y-4 text-center">
            <h2 className="text-3xl font-bold">Localized Automation</h2>
            <p className="text-muted-foreground text-lg">
              Time-zone aware scheduling, language campaigns, local hashtags, and geo-tagged content workflows tailored to your region.
            </p>
          </div>
        </section>
        ...
        <section className="py-20 px-4 md:px-12 bg-muted/50">
          <div className="max-w-6xl mx-auto">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-6 text-sm text-muted-foreground">
              {[
                "Local businesses wanting consistency without full-time hires",
                "Digital agencies managing multiple clients",
                "eCommerce brands running cross-platform campaigns",
                "Influencers and creators scaling output"
              ].map((desc, i) => (
                <div key={i} className="border p-4 rounded-md bg-background shadow-sm">{desc}</div>
              ))}
            </div>
          </div>
        </section>
        ...
        <section className="py-20 px-4 md:px-12">
          <div className="max-w-5xl mx-auto text-center space-y-6">
            <h2 className="text-3xl font-bold">Why Choose Awwtomation?</h2>
            <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6">
              {[
                "Customized automation workflows",
                "Powered by n8n for full control",
                "Transparent pricing & no hidden fees",
                "Ongoing support and consultations",
                "Scalable for all business sizes",
                "Geo-targeted scheduling & localization"
              ].map((item, i) => (
                <div key={i} className="border p-4 rounded-md bg-background shadow-sm text-sm text-muted-foreground">{item}</div>
              ))}
            </div>
          </div>
        </section>
