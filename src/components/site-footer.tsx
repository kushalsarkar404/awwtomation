...
const services = [
  { href: "/services/blog-automation", label: "Blog Agent" },
...
const footerLinkClassName = "text-muted-foreground hover:text-foreground"
      ...
      <div className="container px-4 md:px-6">
        <div className="grid gap-8 md:grid-cols-2 lg:grid-cols-4">
          ...
          <div className="space-y-4">
            ...
            <ul className="space-y-2 text-sm">
              <li>
                <Link href="/templates" className={footerLinkClassName}>
          ...
          <div className="space-y-4">
            ...
            <ul className="space-y-2 text-sm">
              <li>
                <Link href="mailto:contact@awwtomation.com" className={footerLinkClassName}>
                  Contact
                </Link>
              </li>
            </ul>
